...
export default function About(props) {
  ...
  // });
  let myStyle = {
    color: props.mode === 'dark' ? 'white' : '#052947',
    backgroundColor: props.mode === 'dark' ? 'rgb(46 99 143)' : 'white',
    //border: '2x solid',
    //borderColor: props.mode === 'dark' ? 'white' : '#052947',
  }

  return (
    <div className="container">
      <h1 style={{color: props.mode === 'dark' ? 'white' : '#052947'}}>About Us</h1>
